...
public class SinglyLinked<T> {
     ...
     */
    public void merge(SinglyLinked ls1, SinglyLinked ls2) {
        if (ls1.size == 0 || ls2.size == 0 || ls1.head == null || ls2.head == null) {
            return;
        }
        Node ls1Index = ls1.head;
        Node ls2Index = ls2.head;
        //TODO: closed due to can't compare Node.Date
    }
}
